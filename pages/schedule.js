                ...
                <MobileScheduleFilterContainer>
                    ...
                    <div className={`select-wrapper ${isSelected ? 'selected' : ''}`}>
                        <select
                            ...
                            tabIndex={0}
                        >
                            <option value="2024-10-07" tabIndex={0}>Dia 1</option>
                            <option value="2024-10-08" tabIndex={0}>Dia 2</option>
                            <option value="2024-10-09" tabIndex={0}>Dia 3</option>
                            <option value="2024-10-10" tabIndex={0}>Dia 4</option>
                            <option value="2024-10-11" tabIndex={0}>Dia 5</option>
                        </select>
